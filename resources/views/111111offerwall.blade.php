...
<body>
    <!-- Static page -->
    <div style="display: flex ; align-items: start; width: 100%;height: 100%;">
    <div style="display: flex ; height: 100%;    padding-bottom: 60px; align-items: start; width: 100%; flex-direction: column; font-family: Open Sans; background-color:{{ $offerWallTemplate->bodyBg }}">
        ...
        <div style="width:100%; display: flex; flex-direction: column; align-items: flex-start; gap: 15px; padding: 25px;     padding-bottom: 80px; background: {{ $offerWallTemplate->offerBg }};">
