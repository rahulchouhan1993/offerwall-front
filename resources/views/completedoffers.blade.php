...
<body>
    ...
    <div style="display: flex ; height: 100%;    padding-bottom: 60px; align-items: start; width: 100%; flex-direction: column; font-family: Open Sans; background-color:{{ $offerWallTemplate->bodyBg }}">
        ...
        @if($allOffers['offers'])
            ...
            <div class="boxList" style="display: flex; align-items: center; flex-wrap:wrap; gap: 20px; padding: 20px;     box-shadow: 0 0 15px 0 rgba(0, 0, 0, 0.2); border-radius:15px; background: {{ $offerWallTemplate->offerBgInner }}; border: 1px solid {{ $offerWallTemplate->offerBgInner }}; width: 100%;">
                    ...
                    <div class="cntbxsize" style="width: calc(100% - 107px); display: flex; align-items: center; justify-content: space-between;">
                        ...
                        <div style="min-width: 150px;">
                            <a class="btnsm" target="_blank"
                                href="#"
                                style="
                                display: flex ; align-items: center; gap: 10px; padding: 8px 15px 8px 15px; font-family: Open Sans; font-size: 15px; width: 100%; text-align: center; justify-content: center; text-decoration: none; color: #505346; border: 1px solid #000;
                ...
                <div style="display: flex ;     flex-wrap: wrap; justify-content: space-between; align-items: center; width: 100%; background-color: #fff; padding: 9px 15px; border-radius: 6px; gap:10px">
                        <div style="display: flex ; justify-content: space-between; align-items: center; gap: 4px;"><svg style="width: 23px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"></path></svg> <h2 style="font-size: 15px; color: #d196f8; margin: 0; font-weight: 600;">15 Aug 2015</h2></div>


                            <div style=" display: flex ; justify-content: space-between; align-items: center; gap: 4px; font-size: 15px; color: #000;">Device <h2 style="font-size: 15px; color: #d196f8; margin: 0;">Tablet</h2></div>

                            <div style="display: flex ; justify-content: space-between; align-items: center; gap: 10px;">Reward Status 
                                <h2 style="font-size: 15px; margin: 0;  padding: 3px 8px; font-weight: 400; border-radius: 3px; text-align:center " class="pending awarded declined">Pending</h2>
                            </div>
