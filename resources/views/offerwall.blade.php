         ...
         <div style="display: flex ; height: 100%;    padding-bottom: 60px; align-items: start; width: 100%; flex-direction: column; font-family: Open Sans; background-color:{{ $offerWallTemplate->bodyBg }}">
            ...
            <div class="cntmainbx" style="width:100%; display: flex; flex-direction: column; align-items: flex-start; gap: 15px; padding: 60px;     padding-bottom: 80px; background: {{ $offerWallTemplate->offerBg }};">
               ...
               <div class="boxList trigger openPopupDetail" 
                ...
                user="{{ 10 }}"
                style="display: flex; align-items: center; gap: 20px; padding: 20px;box-shadow: 0 0 15px 0 rgba(0, 0, 0, 0.2); border-radius:15px; background: {{ $offerWallTemplate->offerBgInner }}; border: 1px solid {{ $offerWallTemplate->offerBgInner }}; width: 100%;">
         ...
         <div class="modal-content">
            ...
            <div class="modalbx" style="display: flex ; align-items: center; justify-content: flex-start; gap: 20px;">
               ...
               <div style="display: flex ; align-items: center; justify-content: space-between; width: 100%;">
                  <div style="">
                     <h2 style="margin: 0 0 10px; font-weight: 600; font-size: 16px; color: {{ $offerWallTemplate->offerText }};" id="offer-title-pop">--</h2>
                     ...
                     <div style="display: flex ; gap: 10px; align-items: center; color: #757575; margin-bottom: 20px;">
                        ...
                        <div style="font-size: 18px;color: #757575;" id="offer-user-pop">
                           --
                        </div>
                     </div>
                     <div style="width:100%" class="cntbx">
                        <p style="margin: 0; font-family: Open Sans; font-size: 15px; color: #212121;" id="offer-description-pop">---</p>
                     </div>
                     <a href="#" target="_blank" style="display: inline-block; padding: 10px 30px; border-radius: 60px; background: #e788dd; font-size: 18px; color: #fff; text-decoration: none;" id="offer-price-pop">----</a>
                  </div>
               </div>
            </div>
         </div>
