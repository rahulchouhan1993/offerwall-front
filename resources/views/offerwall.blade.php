               ...
               <div style="display: flex ; align-items: center; justify-content: space-between; width: 100%;">
                  <div style="">
                     ...
                     <div style="display: flex ; gap: 10px; align-items: center; color: #757575; margin-bottom: 20px;">
                        ...
                        <div style="font-size: 18px;color:{{ $offerWallTemplate->offerText }}" id="offer-user-pop">
                           --
                        </div>
                     </div>
                     ...
                     <a href="#" target="_blank" style="display: inline-block; padding: 10px 30px; border-radius: 60px; background:{{ $offerWallTemplate->offerButtonBg }}; font-family: 'Inter';  font-size: 18px; color: {{ $offerWallTemplate->offerButtonText }}; text-decoration: none;" id="offer-price-pop">----</a>
                  </div>
               </div>
            </div>
         </div>
